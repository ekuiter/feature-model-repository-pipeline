...
LINUX_50_DUMPCONF="scripts/kconfig/confdata.o,scripts/kconfig/expr.o,scripts/kconfig/preprocess.o,scripts/kconfig/symbol.o,scripts/kconfig/zconf.lex.o,scripts/kconfig/zconf.tab.o"
...
dumpconf() (
    ...
    if ! echo $3 | grep -q dumpconf; then
        yes | make allyesconfig >/dev/null || make $dumpconf_files >/dev/null || true
...
git-run linux v5.0 $LINUX_50_DUMPCONF arch/x86/Kconfig $TAGS
